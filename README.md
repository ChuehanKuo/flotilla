...
An event-sourced coordination kernel for hierarchical, multi-provider AI agent fleets — plus a persistent macOS observatory to watch and steer them live.
...
- **Watch it and talk to it.** A persistent Tauri macOS app renders the fleet as a live animated graph — and lets you inject a message into *any* running node, not just the top. Escalations pause their branch and land in your inbox.
